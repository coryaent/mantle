...
This modification does not aparantly change the operation of MariaDB. All environmental variables can be used in the exact same manner, commands can be passed to the container, and functionality of the `/etc/mysql/conf.d` and `/docker-entrypoint-initdb.d/` directories remains unchanged.
